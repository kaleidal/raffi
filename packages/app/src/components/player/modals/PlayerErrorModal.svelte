...
>
    ...
    >
        ...
        <div class="flex flex-col gap-3">
            <button
                class="w-full py-3 px-4 bg-white text-black text-[15px] font-semibold rounded-xl hover:bg-gray-200 transition-colors cursor-pointer"
                on:click={retry}
            >
                Try Again
            </button>
            <button
                class="w-full py-3 px-4 bg-[#333] text-white text-[15px] font-semibold rounded-xl hover:bg-[#444] transition-colors cursor-pointer"
                on:click={goBack}
            >
                Back to Streams
            </button>
